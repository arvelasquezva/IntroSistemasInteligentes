...
*/    
   ...
   // Agent b_agent =  new Agent( new DummySquaresAgentProgram(Squares.BLACK));
	  Agent black = new Agent( new CuadritoAgentProgram(Squares.BLACK));
	  Agent white = new Agent( new CuadritoAgentProgram(Squares.WHITE));
    SquaresMainFrame frame = new SquaresMainFrame( white ,black);
